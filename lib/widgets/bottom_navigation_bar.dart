...
class LBottomNavigationBar extends StatefulWidget {
  LBottomNavigationBar({
    Key key,
    @required this.items,
    this.onTap,
    this.currentIndex = 0,
...
class _BottomNavigationBarState extends State<LBottomNavigationBar> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(LBottomNavigationBar oldWidget) {
